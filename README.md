...
### اگر به هر دلیلی api call برای ایجاد Transaction با خطا مواجح بشه یک scheduler وجود داره که Donation هایی که در وضعیت IN_PROGRESS هستن رو پیدا میکنه و تلاش میکنه دوباره براشون Transaction ایجاد کنه.
